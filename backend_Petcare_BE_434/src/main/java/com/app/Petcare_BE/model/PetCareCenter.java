...
@Table(name = "\"PetCareCenter\"", schema =  "\"petcare_be\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"petcare_be\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"petcare_be\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"petcare_be\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"petcare_be\"")
